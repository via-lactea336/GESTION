...
const DebitoBancario: React.FC<Props> = ({
  tipoOperacion,
  tipoOperacionNombre,
  dateTime,
  monto,
    ...
    <>
      ...
      <div className="w-1/2 py-4 border-b border-gray-300">
        <div className="flex justify-between w-full">
          <p className="w-1/3 text-base">Banco a debitar:</p>
          <p className="w-2/3 text-base text-right">{nombreDestino}</p>
        </div>
        <div className="flex justify-between w-full">
          <p className="w-1/3 text-base">N° Cuenta:</p>
