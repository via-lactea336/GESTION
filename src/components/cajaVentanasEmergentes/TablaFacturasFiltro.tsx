    ...
    <>
      ...
      <div className="relative">
        ...
        {listaDeFacturas.length === 0 && !loading ? (
          <div>
            <h2 className="border border-white py-2 px-1 text-center">
              No hay facturas
            </h2>
          </div>
        ) : loading ? (
              ...
              {listaDeFacturas.map((factura) => {
                return (
                  <tr key={factura.id} className="border-t border-white">
                    ...
                    <td className="py-2 px-1 border border-white">
                      {Number(factura.ivaTotal).toLocaleString("es-PY")}
                    </td>
                    <td className="py-2 px-1 border border-white">
                      {Number(factura.totalSaldoPagado).toLocaleString("es-PY")}
                    </td>
                    <td className="py-2 px-1 border border-white">
                      {Number(factura.total).toLocaleString("es-PY")}
                    </td>
                    <td className="py-2 px-1 border border-white">
