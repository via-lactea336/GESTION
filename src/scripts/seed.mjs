    ...
    data: [
      {
        ...
        involucradoDocumentoIdentidad: "222333-0",
        involucradoNombre: "Mirian Gonzalez",
        bancoChequeId: itau.id,
        involucradoCuentaBancaria:"1231231231-BCA",
      ...
      },
      {
        ...
        esRecibido: true,
        fechaEmision: new Date(),
        involucradoDocumentoIdentidad: "2224444-0",
        involucradoNombre: "Pedro Ramirez",
        involucradoCuentaBancaria: "18901311824-ABC",
      ...
      },
      {
        ...
        esRecibido: false,
        fechaEmision: new Date(),
        involucradoDocumentoIdentidad: "5554444-0",
        involucradoNombre: "Augusto Tomphson",
        involucradoCuentaBancaria: "1231302624-ABC",
      ...
      },
      {
        ...
        involucradoDocumentoIdentidad: "5554444-0",
        involucradoNombre: "Augusto Tomphson",
        involucradoCuentaBancaria: "12292741824-ABC",
        bancoChequeId: bancoFamiliar.id,
      ...
      },
      {
        ...
        esRecibido: true,
        fechaEmision: new Date(),
        involucradoDocumentoIdentidad: "222378-0",
        involucradoNombre: "Antonio Gonzalez",
        involucradoCuentaBancaria: "123394961824-ABC",
        bancoChequeId: itau.id,
