...
import {WalletIcon, BanknotesIcon, ArrowDownLeftIcon, ArrowUpRightIcon} from "@heroicons/react/24/outline";
...
export default function AccountDetailsTab() {
    ...
    useEffect(() => {
        ...
        try {
            const operacionesReq = await obtenerOperacionesPorCuentaId(id as string);
